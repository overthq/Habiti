	...
	return (
		<>
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to Habiti Dashboard, the
				...
				<li>
					<p>
						...
						this Agreement) refers to Habiti Dashboard.
					</p>
				</li>
				<li>
					<p>
			...
			<ul>
				<li>
					<p>By email: koredefashokun@gmail.com</p>
				</li>
				<li>
					<p>
						By visiting this page on our website:{' '}
						<a
							href='https://habiti.app/privacy-policy'
							rel='external nofollow noopener'
							target='_blank'
						>
							https://habiti.app/privacy-policy
						</a>
					</p>
				</li>
			</ul>
